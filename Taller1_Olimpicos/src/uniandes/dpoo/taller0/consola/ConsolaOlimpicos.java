...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais que representa un atleta dado");
		System.out.println("14. Salir de la aplicación\n");
	}

	private void ejecutarPaisSegunAtleta()
	{
		System.out.println("\n" + "Pais de un atleta" + "\n");
		String nombreAtleta = input("Por favor ingrese el nombre de un atleta");
		String elPais = calculadora.buscarPaisPorAtleta(nombreAtleta);
		if (elPais != null )
		{
		System.out.println("El atleta "+nombreAtleta+ " representa el pais: " + elPais);
		}
		else
		{
